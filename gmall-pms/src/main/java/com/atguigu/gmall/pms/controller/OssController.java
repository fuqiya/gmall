...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4Ft3PuUkJxN9R6zptwt3"; // 请填写您的AccessKeyId。
        String accessKey = "5FDHEAntcigGNpQ3tnDx2yhetyDOtO"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall-fq"; // 请填写您的 bucketname 。
